      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link href={"/blog/semaglutide-weight-loss-guide"} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition">
            ...
            <Link href={"/blog/read-testosterone-blood-test"} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition">
            ...
            <Link href={"/blog"} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-md transition">
