    ...
    <div className="min-h-screen bg-[#0a0e27] text-white font-sans">
      ...
      <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div className="space-y-4">
            {[{ q: "Is this for men or women?", a: "Both. Always. No exceptions." }, { q: "Do I need medical knowledge to read this?", a: "No. It is written for any adult who wants to understand their body." }, { q: "Does this recommend buying hormones or peptides?", a: "No. It educates. You decide what is right for you." }, { q: "Why $79.90 and not $49?", a: "Because this is premium, research-backed content. No fluff." }, { q: "What happens after I buy?", a: "Instant PDF access. Quarterly updates. Lifetime access to your copy." }].map((item, i) => (
